...
class ReceiptService
{
    ...
    public function validateFile(?array $file)
    {
        ...
        if ($file['size'] > $maxFileSizeMB) {
            throw new ValidationException(['receipt' => ['❌ Failed upload is too large']]);
        }
        ...
        $allowedMimesType = ['image/jpeg', 'image/png', 'application/pdf'];

        if (!\in_array($clientMimeType, $allowedMimesType)) {
