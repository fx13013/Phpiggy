    ...
    <table class="table-auto min-w-full divide-y divide-gray-300 mt-6">
        ...
        <tbody class="divide-y divide-gray-200 bg-white">
            <?php foreach ($transactions as $transaction) : ?>
                <tr>
                    <!-- Description -->
                    <td class="p-4 text-sm text-gray-600"><?= escape($transaction['description']) ?></td>
                    <!-- Amount -->
                    <td class="p-4 text-sm text-gray-600"><?= escape($transaction['amount']) ?></td>
                    <!-- Receipt List -->
                    ...
                    <!-- Date -->
                    <td class="p-4 text-sm text-gray-600"><?= escape($transaction['formatted_date']) ?></td>
                    <!-- Actions -->
